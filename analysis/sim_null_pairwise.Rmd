...
rownames(num_effects1) <- paste0("rep", 1:10)
colnames(num_effects1) <- paste0("cond", 1:(R-1))
...
rownames(num_effects2) <- paste0("rep", 1:10)
colnames(num_effects2) <- paste0("cond", 1:(R-1))
...
rownames(num_effects3) <- paste0("rep", 1:10)
colnames(num_effects3) <- paste0("cond", 1:(R-1))
...
rownames(num_effects4) <- paste0("rep", 1:10)
colnames(num_effects4) <- paste0("cond", 1:(R-1))
